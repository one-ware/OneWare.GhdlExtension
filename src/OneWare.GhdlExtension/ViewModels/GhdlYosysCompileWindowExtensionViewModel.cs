...
public class GhdlYosysCompileWindowExtensionViewModel : ObservableObject
{
    ...
    public GhdlYosysCompileWindowExtensionViewModel(UniversalFpgaProjectPinPlannerViewModel pinPlannerViewModel,
